...
{
	public sealed class InfobipExtendedEmailProperties
	{
		private const string ProviderKey = InfobipConst.Id;
		private readonly IExtendedProperties _extendedProperties;

		internal InfobipExtendedEmailProperties(IEmailChannel channel)
		{
		...
		readonly IContentTemplateConfiguration _ampHtml = new ContentTemplateConfiguration();
		/// <summary>
